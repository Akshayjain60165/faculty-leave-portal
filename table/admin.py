...
from table.models import (login_table, login_time, num_of_leaves, cur_running,
                              app_status, cse_dep, ee_dep, mec_dep, hoddean,education,course,
                              cse_hod, mec_hod, ee_hod, hod_dean, director, dean, hodapp, deanapp, dirapp,proffesor,educationproff,courseproff)
...
admin.site.register(educationproff)
admin.site.register(courseproff)